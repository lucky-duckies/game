...
function main() {
  ...
  const models = {
    ...
    fire: { url: "../resources/models/fireball/fire.gltf" }
  };
  {
  ...
  class Fireball extends Component {
    ...
    update() {
      this.transform.translateOnAxis(this.direction, 0.1);
    }
  }
  ...
  class Player extends Component {
    ...
    update() {
      ...
      if (inputManager.keys.right.down) {
        ...
        gameObject.addComponent(Fireball, direction);
  ...
  function init() {
    ...
    {
      const gameObject = gameObjectManager.createGameObject(scene, "fire");
      gameObject.addComponent(Animal, models["fire"]);
